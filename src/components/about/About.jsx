...
const About = () => {
  return (
    <div className="flex h-[80vh] w-full flex-col items-center justify-around   md:h-[90vh] lg:flex-row">
      <div className="flex h-40 w-full items-center justify-around rounded-lg bg-neutral-200 p-4 md:h-56 md:w-3/4 lg:h-[450px] lg:flex-col ">
        <h2 className="font-subtitle text-3xl text-primary_500">¿Quien soy?</h2>
        <img
          src={perfil}
          className=" h-24 w-24 rounded-2xl border-2 border-primary_700 object-cover md:h-40 md:w-40 lg:h-80 lg:w-80"
          alt=""
        />
      </div>

      <div className="flex w-full items-center justify-center rounded-lg bg-primary_700 p-4 md:w-3/4 lg:h-[450px] lg:w-[70ch]">
        <p className="overflow-y-auto text-justify text-xs text-primary_50 md:text-lg">
